...
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_ANCHOR_POINT;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_END_OPACITY;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_OPACITY;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_POSITION;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_ROTATION;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_SCALE;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_SKEW;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_SKEW_ANGLE;
import static com.zeoflow.anidero.AnideroProperty.TRANSFORM_START_OPACITY;
...
public class TransformKeyframeAnimation {
  ...
  public <T> boolean applyValueCallback(T property, @Nullable AnideroValueCallback<T> callback) {
    if (property == TRANSFORM_ANCHOR_POINT) {
      ...
      skewAngle.setValueCallback((AnideroValueCallback<Float>) callback);
    } else {
      return false;
    }
    return true;
