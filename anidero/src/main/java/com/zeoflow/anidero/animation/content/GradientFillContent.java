...
import com.zeoflow.anidero.model.content.GradientFill;
...
public class GradientFillContent
  ...
  public GradientFillContent(final AnideroDrawable anideroDrawable, BaseLayer layer, GradientFill fill) {
    this.layer = layer;
    name = fill.getName();
  ...
  @Override public void draw(Canvas canvas, Matrix parentMatrix, int parentAlpha) {
    ...
    Anidero.beginSection("GradientFillContent#draw");
    path.reset();
    ...
    Anidero.endSection("GradientFillContent#draw");
  }
  ...
  public <T> void addValueCallback(T property, @Nullable AnideroValueCallback<T> callback) {
    if (property == AnideroProperty.OPACITY) {
     ...
     } else if (property == AnideroProperty.GRADIENT_COLOR) {
      if (colorCallbackAnimation != null) {
