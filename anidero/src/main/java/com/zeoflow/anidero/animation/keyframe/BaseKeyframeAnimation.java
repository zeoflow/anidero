...
public abstract class BaseKeyframeAnimation<K, A> {
  ...
  @Nullable protected AnideroValueCallback<A> valueCallback;
  ...
  protected Keyframe<K> getCurrentKeyframe() {
    Anidero.beginSection("BaseKeyframeAnimation#getCurrentKeyframe");
    final Keyframe<K> keyframe = keyframesWrapper.getCurrentKeyframe();
    Anidero.endSection("BaseKeyframeAnimation#getCurrentKeyframe");
    return keyframe;
  }
  ...
  public void setValueCallback(@Nullable AnideroValueCallback<A> valueCallback) {
