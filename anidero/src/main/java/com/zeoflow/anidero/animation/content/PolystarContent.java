...
import com.zeoflow.anidero.model.content.PolystarShape;
...
public class PolystarContent
  ...
  public PolystarContent(AnideroDrawable anideroDrawable, BaseLayer layer,
  ...
  public <T> void addValueCallback(T property, @Nullable AnideroValueCallback<T> callback) {
    if (property == AnideroProperty.POLYSTAR_POINTS) {
      pointsAnimation.setValueCallback((AnideroValueCallback<Float>) callback);
    } else if (property == AnideroProperty.POLYSTAR_ROTATION) {
      rotationAnimation.setValueCallback((AnideroValueCallback<Float>) callback);
    } else if (property == AnideroProperty.POSITION) {
      positionAnimation.setValueCallback((AnideroValueCallback<PointF>) callback);
    } else if (property == AnideroProperty.POLYSTAR_INNER_RADIUS && innerRadiusAnimation != null) {
      innerRadiusAnimation.setValueCallback((AnideroValueCallback<Float>) callback);
    } else if (property == AnideroProperty.POLYSTAR_OUTER_RADIUS) {
      outerRadiusAnimation.setValueCallback((AnideroValueCallback<Float>) callback);
    } else if (property == AnideroProperty.POLYSTAR_INNER_ROUNDEDNESS && innerRoundednessAnimation != null) {
      innerRoundednessAnimation.setValueCallback((AnideroValueCallback<Float>) callback);
    } else if (property == AnideroProperty.POLYSTAR_OUTER_ROUNDEDNESS) {
      outerRoundednessAnimation.setValueCallback((AnideroValueCallback<Float>) callback);
    }
  }
}
