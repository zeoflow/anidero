...
public class ContentGroup implements DrawingContent, PathContent,
  ...
  private static List<Content> contentsFromModels(AnideroDrawable drawable, BaseLayer layer,
  ...
  public ContentGroup(final AnideroDrawable anideroDrawable, BaseLayer layer, ShapeGroup shapeGroup) {
    this(anideroDrawable, layer, shapeGroup.getName(),
        shapeGroup.isHidden(), contentsFromModels(anideroDrawable, layer, shapeGroup.getItems()),
        findTransform(shapeGroup.getItems()));
  }

  ContentGroup(final AnideroDrawable anideroDrawable, BaseLayer layer,
  ...
  @Override public void draw(Canvas canvas, Matrix parentMatrix, int parentAlpha) {
    ...
    boolean isRenderingWithOffScreen = anideroDrawable.isApplyingOpacityToLayersEnabled() && hasTwoOrMoreDrawableContent() && layerAlpha != 255;
