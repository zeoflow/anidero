...
public abstract class BaseAnideroAnimator extends ValueAnimator {
  ...
  @Override public long getStartDelay() {
    throw new UnsupportedOperationException("AnideroAnimator does not support getStartDelay.");
  }

  @Override public void setStartDelay(long startDelay) {
    throw new UnsupportedOperationException("AnideroAnimator does not support setStartDelay.");
  }
  @Override public ValueAnimator setDuration(long duration) {
    throw new UnsupportedOperationException("AnideroAnimator does not support setDuration.");
  }

  @Override public void setInterpolator(TimeInterpolator value) {
    throw new UnsupportedOperationException("AnideroAnimator does not support setInterpolator.");
  }
