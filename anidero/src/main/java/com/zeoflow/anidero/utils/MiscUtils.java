...
import com.zeoflow.anidero.animation.content.KeyPathElementContent;
import com.zeoflow.anidero.model.CubicCurveData;
  ...
  public static void getPathFromData(ShapeData shapeData, Path outPath) {
    ...
    for (int i = 0; i < shapeData.getCurves().size(); i++) {
      ...
      if (cp1.equals(pathFromDataCurrentPoint) && cp2.equals(vertex)) {
        ...
        // https://github.com/airbnb/anidero-android/issues/275
        //
