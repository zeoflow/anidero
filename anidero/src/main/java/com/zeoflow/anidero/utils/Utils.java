...
import com.zeoflow.anidero.animation.content.TrimPathContent;
...
public final class Utils {
  ...
  public static void applyTrimPathIfNeeded(
    ...
    Anidero.beginSection("applyTrimPathIfNeeded");
    ...
    if (startValue == 1f && endValue == 0f) {
      Anidero.endSection("applyTrimPathIfNeeded");
      return;
    }
  ...
  public static void saveLayerCompat(Canvas canvas, RectF rect, Paint paint, int flag) {
    Anidero.beginSection("Utils#saveLayer");
    ...
    Anidero.endSection("Utils#saveLayer");
  }
