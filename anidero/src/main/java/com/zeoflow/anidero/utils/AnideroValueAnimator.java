 ...
 */
public class AnideroValueAnimator extends BaseAnideroAnimator implements Choreographer.FrameCallback {
  ...
  @Override public void doFrame(long frameTimeNanos) {
    ...
    Anidero.beginSection("AnideroValueAnimator#doFrame");
    ...
    verifyFrame();
    Anidero.endSection("AnideroValueAnimator#doFrame");
  }
  ...
  public void setComposition(AnideroComposition composition) {
