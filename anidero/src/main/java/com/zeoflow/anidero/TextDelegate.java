...
public class TextDelegate {
  ...
  @Nullable private final AnideroAnimationView animationView;
  @Nullable private final AnideroDrawable drawable;
  ...
  public TextDelegate(
      @SuppressWarnings("NullableProblems") AnideroAnimationView animationView) {
    this.animationView = animationView;
    drawable = null;
  }

  @SuppressWarnings("unused")
  public TextDelegate(@SuppressWarnings("NullableProblems") AnideroDrawable drawable) {
