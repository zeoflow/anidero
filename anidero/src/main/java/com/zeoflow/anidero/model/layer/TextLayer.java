...
import com.zeoflow.anidero.TextDelegate;
...
import com.zeoflow.anidero.model.DocumentData.Justification;
import com.zeoflow.anidero.model.Font;
import com.zeoflow.anidero.model.FontCharacter;
import com.zeoflow.anidero.model.animatable.AnimatableTextProperties;
...
public class TextLayer extends BaseLayer {
  ...
  private final AnideroComposition composition;
  @Nullable
  ...
  TextLayer(AnideroDrawable anideroDrawable, Layer layerModel) {
  ...
  void drawLayer(Canvas canvas, Matrix parentMatrix, int parentAlpha) {
    canvas.save();
    if (!anideroDrawable.useTextGlyphs()) {
  ...
  private void drawTextWithFont(
    ...
    float parentScale = Utils.getScale(parentMatrix);
    Typeface typeface = anideroDrawable.getTypeface(font.getFamily(), font.getStyle());
    if (typeface == null) {
      return;
    }
    String text = documentData.text;
    TextDelegate textDelegate = anideroDrawable.getTextDelegate();
  ...
  private List<ContentGroup> getContentsForCharacter(FontCharacter character) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      contents.add(new ContentGroup(anideroDrawable, this, sg));
    }
  ...
  public <T> void addValueCallback(T property, @Nullable AnideroValueCallback<T> callback) {
    ...
    if (property == AnideroProperty.COLOR) {
      ...
      if (callback == null) {
        ...
        colorCallbackAnimation = new ValueCallbackKeyframeAnimation<>((AnideroValueCallback<Integer>) callback);
        colorCallbackAnimation.addUpdateListener(this);
        addAnimation(colorCallbackAnimation);
      }
    } else if (property == AnideroProperty.STROKE_COLOR) {
      if (strokeColorCallbackAnimation != null) {
      ...
      if (callback == null) {
        ...
        strokeColorCallbackAnimation = new ValueCallbackKeyframeAnimation<>((AnideroValueCallback<Integer>) callback);
        strokeColorCallbackAnimation.addUpdateListener(this);
        addAnimation(strokeColorCallbackAnimation);
      }
    } else if (property == AnideroProperty.STROKE_WIDTH) {
      if (strokeWidthCallbackAnimation != null) {
      ...
      if (callback == null) {
        ...
        strokeWidthCallbackAnimation = new ValueCallbackKeyframeAnimation<>((AnideroValueCallback<Float>) callback);
        strokeWidthCallbackAnimation.addUpdateListener(this);
        addAnimation(strokeWidthCallbackAnimation);
      }
    } else if (property == AnideroProperty.TEXT_TRACKING) {
      if (trackingCallbackAnimation != null) {
      ...
      if (callback == null) {
        ...
        trackingCallbackAnimation = new ValueCallbackKeyframeAnimation<>((AnideroValueCallback<Float>) callback);
        trackingCallbackAnimation.addUpdateListener(this);
        addAnimation(trackingCallbackAnimation);
      }
    } else if (property == AnideroProperty.TEXT_SIZE) {
      if (textSizeCallbackAnimation != null) {
      ...
      if (callback == null) {
        ...
        textSizeCallbackAnimation = new ValueCallbackKeyframeAnimation<>((AnideroValueCallback<Float>) callback);
