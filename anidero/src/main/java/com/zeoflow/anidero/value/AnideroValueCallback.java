...
/**
 * Allows you to set a callback on a resolved {@link com.zeoflow.anidero.model.KeyPath} to modify
 * its animation values at runtime.
 */
public class AnideroValueCallback<T> {
  private final AnideroFrameInfo<T> frameInfo = new AnideroFrameInfo<>();
  ...
  public AnideroValueCallback() {
  }

  public AnideroValueCallback(@Nullable T staticValue) {
    value = staticValue;
  }
