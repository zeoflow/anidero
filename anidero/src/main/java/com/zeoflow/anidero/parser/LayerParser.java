...
public class LayerParser {
  ...
  public static Layer parse(AnideroComposition composition) {
  ...
  public static Layer parse(JsonReader reader, AnideroComposition composition) throws IOException {
    ...
    while (reader.hasNext()) {
      switch (reader.selectName(NAMES)) {
        ...
        case 13:
          ...
          reader.endArray();
          composition.addWarning("Anidero doesn't support layer effects. If you are using them for " +
