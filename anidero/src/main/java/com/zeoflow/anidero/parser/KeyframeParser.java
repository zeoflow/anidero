...
class KeyframeParser {
  ...
  // https://github.com/airbnb/anidero-android/issues/464
  private static SparseArrayCompat<WeakReference<Interpolator>> pathInterpolatorCache() {
  ...
  static <T> Keyframe<T> parse(JsonReader reader, AnideroComposition composition,
   ...
   */
  private static <T> Keyframe<T> parseKeyframe(AnideroComposition composition, JsonReader reader,
    ...
    if (hold) {
      ...
      if (interpolatorRef == null || interpolator == null) {
        ...
        try {
          ...
          //     https://github.com/airbnb/anidero-android/issues/452
